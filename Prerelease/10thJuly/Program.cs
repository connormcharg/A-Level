...
namespace Original
{
    internal class Program
    {
        ...
        private static void PlayGame(List<int> Targets, List<int> NumbersAllowed, bool TrainingGame, int MaxTarget, int MaxNumber)
        {
            int Score = 0;
            bool GameOver = false;
            string UserInput;
        ...
        private static bool CheckIfUserInputEvaluationIsATarget(List<int> Targets, List<string> UserInputInRPN, ref int Score)
        {
        ...
        private static void RemoveNumbersUsed(string UserInput, int MaxNumber, List<int> NumbersAllowed)
        {
        ...
        private static void UpdateTargets(List<int> Targets, bool TrainingGame, int MaxTarget)
        {
        ...
        private static bool CheckNumbersUsedAreAllInNumbersAllowed(List<int> NumbersAllowed, List<string> UserInputInRPN, int MaxNumber)
        {
        ...
        private static bool CheckValidNumber(string Item, int MaxNumber)
        {
        ...
        private static void DisplayState(List<int> Targets, List<int> NumbersAllowed, int Score)
        {
        ...
        private static void DisplayNumbersAllowed(List<int> NumbersAllowed)
        {
        ...
        private static void DisplayTargets(List<int> Targets)
        {
            Console.Write("|");
        ...
        private static List<string> ConvertToRPN(string UserInput)
        {
            int Position = 0;
        ...
        private static int EvaluateRPN(List<string> UserInputInRPN)
        {
        ...
        private static int GetNumberFromUserInput(string UserInput, ref int Position)
        {
            string Number = "";
        ...
        private static bool CheckIfUserInputValid(string UserInput)
        {
            return Regex.IsMatch(UserInput, @"^([0-9]+[\+\-\*\/])+[0-9]+$");
        }

        private static int GetTarget(int MaxTarget)
        {
        ...
        private static List<int> CreateTargets(int SizeOfTargets, int MaxTarget)
        {
        ...
        private static List<int> FillNumbers(List<int> NumbersAllowed, bool TrainingGame, int MaxNumber)
        {
            if (TrainingGame)
            {
